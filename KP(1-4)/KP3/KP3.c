...
{\field{\*\fldinst{HYPERLINK "tg://search_hashtag?hashtag=include"}}{\fldrslt 
\f0\fs32 \cf2 \cb3 \expnd0\expndtw0\kerning0
\outl0\strokewidth0 \strokec2 #include}}
\f0\fs32 \cf2 \cb3 \expnd0\expndtw0\kerning0
\outl0\strokewidth0 \strokec2  <stdio.h> \
{\field{\*\fldinst{HYPERLINK "tg://search_hashtag?hashtag=include"}}{\fldrslt #include}} <float.h> \
{\field{\*\fldinst{HYPERLINK "tg://search_hashtag?hashtag=include"}}{\fldrslt #include}} <stdint.h> \
{\field{\*\fldinst{HYPERLINK "tg://search_hashtag?hashtag=include"}}{\fldrslt #include}} <math.h> \
\
