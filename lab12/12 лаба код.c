    ...
    while ((c = getchar()) != 'a') {
        if (isdigit(c) == 0) {
            if (resNum == 0) {
                ...
                if (tmpPair) {
                    printf("%d ", reverseNum(tmpPair, 0, 0));
                ...
                if (digit1 != -1) {
                    if (isdigit(c))
                        printf("%d ", digit1 > (c - '0') ? (c - '0') * 10 + digit1 : digit1 * 10 + (c - '0'));
                    else printf("%d ", digit1);
                } else {
                    if (isdigit(c))
                        printf("%d ", digit2 > (c - '0') ? (c - '0') * 10 + digit2 : digit2 * 10 + (c - '0'));
                    printf("%d ", digit2);
                }
        ...
        if (digit1 == -1 || digit2 == -1) {
            ...
            if (digit1 != -1 && digit2 != -1) {
                tmpPair = getNewPair(digit1, digit2, 0, 0);
            }
        } else {
